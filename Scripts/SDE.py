...
# Ejemplo de uso
folder_path = r'C:\Users\Facu\Downloads\Bootstrap_Kisangami4_2018'  # Reemplaza con tu ruta
...
if mean_data is not None and std_data is not None:
    ...
    output_mean_path = os.path.join(folder_path, 'Bootstrap_Kisangami4_mean_2018.tif')
    output_std_path = os.path.join(folder_path, 'Bootstrap_Kisangami4_2018.tif')
