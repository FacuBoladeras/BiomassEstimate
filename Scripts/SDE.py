...
# Ejemplo de uso
folder_path = r'C:\Users\Facu\Downloads\Rf_Bootstrap_Betroka_2015'  # Reemplaza con tu ruta
...
if mean_data is not None and std_data is not None:
    ...
    output_mean_path = os.path.join(folder_path, 'Rf_Bootstrap_Betroka_2015_mean.tif')
    output_std_path = os.path.join(folder_path, 'Rf_Bootstrap_Betroka_2015_sde.tif')
