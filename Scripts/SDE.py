...
# Ejemplo de uso
folder_path = r'C:\Users\Facu\Downloads\Rf_Bootstrap_mdg_south_20119'  # Reemplaza con tu ruta
...
if mean_data is not None and std_data is not None:
    ...
    output_mean_path = os.path.join(folder_path, 'Bootstrap_mdg_south_2019_mean.tif')
    output_std_path = os.path.join(folder_path, 'Bootstrap_mdg_south_2019_sde.tif')
